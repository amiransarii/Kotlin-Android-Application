package org.app.kotlinandroidapplication.adapter
...
import org.app.kotlinandroidapplication.R
...
class CustomAdapter(context: Context,arrayListDetails:ArrayList<Model>) : BaseAdapter(){
    ...
    override fun getView(position: Int, convertView: View?, parent: ViewGroup): View? {
        ...
        if (convertView == null) {
            view = this.layoutInflater.inflate(R.layout.custom_json_layout, parent, false)
